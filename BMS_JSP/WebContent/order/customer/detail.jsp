			...
			<div class="row">
				...
				<div class="col-md-9">
					...
					<div class="form-group pull-right" role="group">
						<button class="btn btn-danger" type="button" id="cancelOrder">
							<span class="glyphicon glyphicon-remove" aria-hidden="true"></span> 주문 취소
						</button>
						<button class="btn btn-danger" type="button" id="refundOrder">
							<span class="glyphicon glyphicon-remove" aria-hidden="true"></span> 환불 요청
						</button>
					</div>

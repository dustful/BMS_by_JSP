							...
							<tbody>
								<c:forEach var="order" items="${orders}">
									<tr>
										...
										<td class="text-center">${order.mid}</td>
										...
										<td class="text-center">
											<button class="btn btn-primary" type="button" data-toggle="tooltip" data-placement="top" title="상세보기" onClick="location.href = 'sellerOrderDetail.do?orgNum=${order.odref}'">
